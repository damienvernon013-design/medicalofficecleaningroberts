...
const ZIP_DEFAULT = '54023'; // Roberts, WI
const ADDRESS_DEFAULT = 'Roberts, WI';
const SITE_SOURCE_TAG = 'Site: medicalofficecleaningroberts.com';
...
// Minutes since midnight for each SCHEDULES id, from assets/js/quote-wizard.js.
...
function buildWizardPayload(body) {
  ...
  const notes = [SITE_SOURCE_TAG, rawNotes].filter(Boolean).join(' | ');
